...
extern const unsigned int WelcomeMusic_sampleRate;
extern const unsigned int WelcomeMusic_length;
extern const signed char WelcomeMusic_data[];
# 14 "play.c" 2
# 1 "GameplayMusic.h" 1


extern const unsigned int GameplayMusic_sampleRate;
extern const unsigned int GameplayMusic_length;
extern const signed char GameplayMusic_data[];
# 15 "play.c" 2
# 1 "pausemusic.h" 1


extern const unsigned int pausemusic_sampleRate;
extern const unsigned int pausemusic_length;
extern const signed char pausemusic_data[];
# 16 "play.c" 2
# 1 "WinMusic.h" 1
...
extern const unsigned int plantSound_sampleRate;
extern const unsigned int plantSound_length;
extern const signed char plantSound_data[];
# 18 "play.c" 2
# 1 "loseSound.h" 1
